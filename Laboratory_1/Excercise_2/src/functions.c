 ...
 * @param day Pointer to an integer that will store the calculated day of the
 * month.
 * @param month Pointer to an integer that will store the calculated month.
 * @param year Pointer to an integer that will store the calculated year.
 *
 */
